...
export class addComponentDraftTable1650140109067 implements MigrationInterface {
    name = 'addComponentDraftTable1650140109067'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "component_drafts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_by" uuid NOT NULL, "workload_id" uuid, "code" character varying NOT NULL DEFAULT '', "name" character varying NOT NULL DEFAULT '', "department" character varying NOT NULL DEFAULT '', "program" character varying NOT NULL DEFAULT '', "semester" character varying NOT NULL DEFAULT '', "prerequeriments" character varying NOT NULL DEFAULT '', "methodology" character varying NOT NULL DEFAULT '', "objective" character varying NOT NULL DEFAULT '', "syllabus" character varying NOT NULL DEFAULT '', "bibliography" character varying NOT NULL DEFAULT '', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "REL_d67562e0144765b0c9b2b55570" UNIQUE ("workload_id"), CONSTRAINT "PK_ed9d7b7a98302a71818770f67a3" PRIMARY KEY ("id"))`);
